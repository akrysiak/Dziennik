<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EdytujOcene2.aspx.cs" Inherits="pages_EdytujOcene2" %>
    ...
    <div id="content_wrapper">
        ...
        <div id="content">
            <form id="form1" runat="server">
                Ocena:<br />
                <asp:DropDownList ID="ddlOcena" runat="server" Height="18px" Width="130px">
