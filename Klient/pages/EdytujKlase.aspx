<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EdytujKlase.aspx.cs" Inherits="pages_EdytujKlase" %>
...
<body>
    ...
    <div id="content_wrapper">
        ...
        <div id="content">
               	  ...
               	  <asp:Label ID="Label1" runat="server" Text="Edytuj klase:"></asp:Label><br />                
                    <br />
                  <asp:Label ID="lbNazwa" runat="server" Text="Nazwa klasy:" /><br />
                   <asp:TextBox ID="tbNazwa" runat="server" Width="150" /> <br /><br />
