...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EdytujOcene.aspx.cs" Inherits="pages_EdytujOcene" %>
    ...
    <div id="content_wrapper">
        ...
        <div id="content">
            <form id="form1" runat="server">
                Przedmiot:
                <asp:Label ID="lblPrzedmiot" runat="server"></asp:Label>
&nbsp;<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="446px">
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/pages/EdytujOcene2.aspx?Id={0}" Text="Edytuj" />
                        </Columns>
                    </asp:GridView>
            </form>
