<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Klasa.aspx.cs" Inherits="pages_Klasa" %>
    ...
    <div id="content_wrapper">
       ...
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="446px">
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/pages/EdytujKlase.aspx?Id={0}" Text="Edytuj" />
                        </Columns>
                    </asp:GridView>
                <asp:Button ID="btnDodaj" runat="server" OnClick="btnDodaj_Click" Text="Dodaj klasę" />
            </form>
