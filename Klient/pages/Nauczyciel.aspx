<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Nauczyciel.aspx.cs" Inherits="pages_Nauczyciel" %>
    ...
    <div id="content_wrapper">
       ...
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="446px">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Nauczyciel" HeaderText="Nauczyciel" />
                            <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/pages/EdytujNauczyciela.aspx?Id={0}" Text="Edytuj" />
                            <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/pages/UsunNauczyciela.aspx?Id={0}" Text="Usuń" />
                        </Columns>
                    </asp:GridView>
                <asp:Button ID="btnDodaj" runat="server" OnClick="btnDodaj_Click" Text="Dodaj nauczyciela" />
            </form>
