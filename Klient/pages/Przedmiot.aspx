<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Przedmiot.aspx.cs" Inherits="pages_Przedmiot" %>
    ...
    <div id="content_wrapper">
       ...
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="446px">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Nazwa" HeaderText="Przedmiot" />
                            <asp:BoundField DataField="IdNauczyciela" HeaderText="IdN" Visible="False" />
                            <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/pages/EdytujPrzedmiot.aspx?Id={0}" Text="Edytuj" />
                        </Columns>
                    </asp:GridView>
                <asp:Button ID="btnDodaj" runat="server" OnClick="btnDodaj_Click" Text="Dodaj przedmiot" />
            </form>
