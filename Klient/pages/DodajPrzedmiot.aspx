<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DodajPrzedmiot.aspx.cs" Inherits="pages_DodajPrzedmiot" %>
    ...
    <div id="content_wrapper">
        ...
        <div id="content">
                 Dodaj przedmiot:<br />                
                    <br />
                  Przedmiot:<br />
                   <asp:TextBox ID="tbPrzedmiot" runat="server" Width="150" /> <br />
                 <asp:RequiredFieldValidator ID="rv1" runat="server" ControlToValidate="tbPrzedmiot" EnableClientScript="False" ErrorMessage="Pole wymagane" ForeColor="Red" ValidationGroup="dodawaniep"></asp:RequiredFieldValidator>
                 <br />
                    Nauczyciel:<br />
