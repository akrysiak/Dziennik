<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OcenyUczen.aspx.cs" Inherits="pages_OcenyUczen" %>
    ...
    <div id="content_wrapper">
       ...
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="446px">
                        <Columns>
                            ...
                            <asp:BoundField DataField="sPrzedmiot" HeaderText="Przedmiot" />
                            <asp:BoundField DataField="sOceny" HeaderText="Oceny" />
                        </Columns>
                    </asp:GridView>
            </form>
