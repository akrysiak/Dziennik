<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DodajKlase.aspx.cs" Inherits="pages_DodajKlase" %>
<!DOCTYPE html>
...
<body>
    ...
    <div id="content_wrapper">
        ...
        <div id="content">
                 Dodaj klasę:<br />                
                    <br />
                  <asp:Label ID="lbNazwa" runat="server" Text="Nazwa klasy:" /><br />
                   <asp:TextBox ID="tbNazwa" runat="server" Width="150" /> <br />
                 <asp:RequiredFieldValidator ID="rv1" runat="server" ControlToValidate="tbNazwa" EnableClientScript="False" ErrorMessage="Pole Wymagane" ForeColor="Red" ValidationGroup="dodawaniek"></asp:RequiredFieldValidator>
                 <br />
                    <asp:Label ID="lbWychowawca" runat="server" Text="Wychowawca" />:<br />
                     <asp:DropDownList ID="ddlWychowawca" runat="server" Width="150"/>
                  <br />
                  <br />
